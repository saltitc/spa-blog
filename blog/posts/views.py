...
class PostDetailView(DetailView):
    ...
    def post(self, request, slug, *args, **kwargs):
        ...
        return render(request, "posts/post_detail.html", context={"comment_form": comment_form})
...
class SearchResultsView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request, "posts/search.html", context={"title": "Поиск", "results": page_obj, "count": paginator.count}
        )
...
class TagView(View):
    def get(self, request, slug, *args, **kwargs):
        ...
        return render(
            request, "posts/tag.html", context={"title": f"#ТЕГ {tag}", "posts": posts, "common_tags": common_tags}
        )
